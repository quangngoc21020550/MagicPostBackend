...
from app.models.category import manager, managerdb, gatheringPointdb, transactionPointdb
...
validate_token: str = Header("")
    ...
    try:
        ...
        resp = manager.signUp(encoded_body, managerdb, gatheringPointdb, transactionPointdb)
