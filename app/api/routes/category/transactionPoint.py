...
from app.models.category import transactionPoint, transactionPointdb
...
async def insedrt(
    transactionPoint: transactionPoint.transactionPointInsmodel = Body(..., embed=True),
    ...
    # )
    try:
        ct = jsonable_encoder(transactionPoint)
        resp = transactionPointdb.insert_doc("", json=ct)
        # dict_cache.runApp()
